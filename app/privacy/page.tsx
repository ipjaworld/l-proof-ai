  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <section><h2>처리 시스템</h2><p>Cloudflare Sites에서 웹 서비스를 운영하고 Cloudflare D1에 신청 정보를 저장합니다. 운영 알림에는 Resend를 사용하며, 운영 환경에 발송 자격 증명이 설정된 경우에만 이메일 처리가 이뤄집니다.</p></section>
        <section><h2>권리와 문의</h2><p>열람·정정·삭제·수신거부를 요청할 수 있습니다. 수신거부는 <Link href="/unsubscribe">전용 페이지</Link>에서 직접 처리하거나 <a href="mailto:lproof073@gmail.com">lproof073@gmail.com</a>으로 문의해주세요.</p></section>
      </article>
    </main>
  );
}
