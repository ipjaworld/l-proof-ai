export const siteContent = {
  hero: {
    description:
      "코딩 에이전트와 LLM, AGI 소식을 원문으로 확인하고 중요한 건 직접 써본 뒤, 제 판단과 이번 주에 해볼 일까지 붙여 월요일과 목요일 아침에 보내드려요.",
    footnote:
      "무료예요. 신청하면 제가 직접 확인한 뒤 발송을 시작해요. 언제든 그만 받을 수 있어요.",
  },
  proofLevels: [
  ...
  loop: {
    intro: "AI를 빼지 않아요. 대신 사람이 멈춰 서야 할 지점을 분명히 둬요.",
    steps: [
      { label: "모으기", owner: "AI" },
  ...
  brief: {
    ...
    summary:
      "하나의 코딩 작업을 작은 단위로 나눠 동시에 검토하는 방식이 공개됐다는 가정으로, 브리핑 한 항목이 어떻게 구성되는지 보여드려요.",
    impact:
      "병렬 실행 자체보다 작업 경계와 결과 검증 방식이 실제 개발 시간을 줄이는지 확인해야 해요.",
    take: "빠른 결과보다, 누가 무엇을 검증했는지가 남는 워크플로가 더 오래가요. 틀릴 수 있고, 틀리면 기록해요.",
    action:
  ...
  operator: {
    ...
    introduction:
      "안녕하세요, 이건하예요. AI 도구로 직접 서비스를 만드는 개발자예요. 여러 코딩 에이전트를 목적에 따라 나눠 쓰고, 서로 다른 모델의 답을 교차검증하고, 마지막 결과는 실제 브라우저에서 다시 확인하는 방식으로 일해요. L-Proof-AI도 같은 방식으로 만들어요.",
    now: [
  ...
  editorialPrinciples: [
    "공식 발표·release note·논문을 먼저 확인해요.",
