/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 7eed8cd779cbdff07894d78d44833a1b)
// Runtime types generated with workerd@1.20260918.1 2026-09-24 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	OPERATOR_NOTIFICATION_EMAIL: "ipjaworld@gmail.com";
	EMAIL_FROM: "L-Proof-AI <notify@mail.l-proof-ai.xyz>";
	SITE_URL: "https://l-proof-ai.xyz";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPERATOR_NOTIFICATION_EMAIL" | "EMAIL_FROM" | "SITE_URL">> {}
}
